    ...
    <footer>
      <div className="footer-content">
        ...
        <Typography variant="body2" className="copyright">
          <a href="https://innovacio.xtec.gencat.cat/">{title} v{version}</a><br />
          <a href={author.url}>{`© 2019-${(new Date()).getFullYear()} ${author.name}`}</a><br />
          ...
          <br />
          <strong>Bústia de contacte</strong>: <a href={`mailto:${author.email}`}>{author.email}</a><br />
          <br />
