...
if (tp=='centres'){
	...
	row_cap[0]=['id','codi_centre','Latitud','Longitud','Codi_ST','Nom_programa','curs','Municipi','Naturalesa','Nom','TipusCentre','Ambits_innovacio', 'Ambits_curriculars','Logo','Web']
	row_cap[1]=['id','codi_centre','Latitud','Longitud','selFiltre','selFiltre','selFiltre','Municipi','selFiltre','Nom','selFiltre','csvFiltre','csvFiltre','Logo','Web'];	
	row_cap[2]=['taula:visu','codi_centre','Latitud','Longitud','taula:visu','taula:visu','taula:visu','taula:visu','taula:visu','taula:visu','taula:visu','taula:visu', 'taula:visu','Logo','Web'];	
}
...
function canviOpacitatFonsPoligon(val){
    alert(val);
    opacitatFonsPoligon=parseInt($('#opacitatFonsPoligon').val()/100);
    aplicacioFiltres();             
}; 
  ...
  //poligons
	if(row_poligons!=null) {
      ...
      coefOpacitat=(valMax-valMin)/5;
            ...
            console.log(opacitatFonsPoligon);
...
function onCenPrograma(row_cen){
  //console.log(row_cen);
      var divMsg ="<h3>Relació de centres</h3>";
