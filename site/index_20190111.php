...
if (tp=='centres'){
	...
	row_cap[0]=['id','codi_centre','Latitud','Longitud','Codi_ST','Nom_programa','curs','Municipi','Naturalesa','Nom','TipusCentre','Ambits_innovacio', 'Ambits_curriculars','Logo','Web','Descripcio','Enllac']
	row_cap[1]=['id','codi_centre','Latitud','Longitud','selFiltre','selFiltre','selFiltre','Municipi','selFiltre','Nom','selFiltre','csvFiltre','csvFiltre','Logo','Web','Descripcio','Enllac'];	
	row_cap[2]=['taula:visu','codi_centre','Latitud','Longitud','taula:visu','taula:visu','taula:visu','taula:visu','taula:visu','taula:visu','taula:visu','taula:visu', 'taula:visu','Logo','Web','Descripcio','Enllac'];	
}
   ...
   for (var i=Num_files_capçalera;i<finalArray.length;i++) {
       if (!repetit[i]) {
         ...
         for(var j=i+1;j<finalArray.length;j++) {
            console.log(numColLatitud+"--"+numColLongitud)
